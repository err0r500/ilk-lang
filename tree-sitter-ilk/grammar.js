...
module.exports = grammar({
    ...
    rules: {
        ...
        // ===================
        _type_expr: ($) =>
            choice($.union_type, $.intersection_type, $._primary_type),
        ...
        concrete_type: ($) => seq("Concrete", "<", $._type_expr, ">"),

        list_type: ($) =>
            seq("[", optional($.cardinality), "]", $._primary_type),
        ...
        constraint_or: ($) =>
            prec.left(
                PREC.OR,
                seq($._constraint_expr, "||", $._constraint_expr),
            ),
        ...
        constraint_field_access: ($) =>
            prec.left(
                PREC.FIELD_ACCESS,
                seq($._constraint_expr, ".", $.identifier),
            ),
        ...
        struct_value: ($) => seq("{", optional($.value_field_list), "}"),
        ...
        list_value: ($) => seq("[", optional($.list_elements), "]"),

        list_elements: ($) => commaSep1($.list_element),

        list_element: ($) => choice($.refinement, $._value),
